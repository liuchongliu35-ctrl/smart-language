...
public class OCRHttpSend {
    private String requestUrl = "https://api.xf-yun.com/v1/private/hh_ocr_recognize_doc";
    //控制台获取以下信息
    private String appid = "6987ab2c";
    private String apiSecret = "ZTllMGJjMTljY2M3YjkwMjg3ZmJjZjlh";
    private String apiKey = "9103eb8cfe17fea12e1867df3afdcabf";
     ...
     * @throws Exception 异常
     */
    public String doRequest(String IMAGE_PATH) throws Exception {

        URL realUrl = new URL(buildRequetUrl(IMAGE_PATH));
        ...
        String params = buildParam(IMAGE_PATH);
     ...
     * @return 处理后的URL
     */
    public String buildRequetUrl(String IMAGE_PATH){
        URL url = null;
     ...
     * @return 参数字符串
     */
    private String  buildParam(String IMAGE_PATH) throws Exception{
        String param = "{"+
                "    \"header\": {"+
                "        \"app_id\": \""+appid+"\","+
                "        \"status\": 3"+
