...
public class VoiceImpl {
    ...
    //3、通过classpath：
    private static final String AUDIO_FILE_PATH ="H:\\EduPlatForm\\src\\main\\resources\\audioFromClient\\lfasr.wav";
...
//        System.out.println("转写结果: \n" + result.getData());
    ...
    public static void showResult(String result){
        ...
        List<ResultData> resultData = gson.fromJson(result, type);
